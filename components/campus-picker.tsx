...
export function CampusPicker({ value, onChange, label = "Campus", placeholder = "Search Indian colleges and universities", required = false }: { value: string; onChange: (value: string) => void; label?: string; placeholder?: string; required?: boolean }) {
